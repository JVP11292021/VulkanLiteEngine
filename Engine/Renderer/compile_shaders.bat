...
C:\VulkanSDK\1.4.313.2\Bin\glslc.exe shaders\point_light.vert -o shaders\point_light.vert.spv
C:\VulkanSDK\1.4.313.2\Bin\glslc.exe shaders\point_light.frag -o shaders\point_light.frag.spv
pause